const ACH_DATA = {
	...
	descs: {
		...
		58: () => "Go at least " + formatDistance(new EN(1e100).times(DISTANCES.uni)) + ".",

		61: "Unlock Pathogens.",
		62: "Reach showNum(1e+6) Life Essence.",
		63: "Reach showNum(1e71) Time Cubes.",
		64: "Reach Rank showNum(50).",
		65: "Reach showNum(5e+7) Cadavers.",
		66: "Get Fuelbot's interval less than or equal to formatTime(120).",
		67: () => "Reach "+ formatDistance(new EN(1e200).times(DISTANCES.uni))+".",
		...
		83: "Reach showNum(2) endorsements.",
		...
		88: "Reach showNum(7) Endorsements.",

		91: "Have a Dark Flow of at least showNum(8e3)x.",
		92: "Reach showNum(1e1000) Cadavers.",
		...
		97: "Reach formatDistance(1e650) without any Pathogen Upgrades.",
		...
		103: "Reach showNum(1e250) Dark Matter.",
		...
		112: () => "Reach " + formatDistance("1e1e5") + "/s^2 of acceleration.",
		...
		138: () => "Reach " + formatDistance("1e5e5") + " while having ten Endorsements or less.",
		...
		147: () => "Reach Rank " + showNum(2000) + " with ten Endorsements or less.",
		148: "Reach Rank showNum(2e4).",
	...
	rewards: {
		...
		25: "Tiers power up Rank 4 reward",
		...
		46: "Scraps boost intelligence gain and max velocity and different rates",
		47: "Time goes by showNum(50)% faster.",
		48: "You can buy max robot upgrades.",

		51: "Maximum Velocity and Acceleration is xshowNum(200) higher, but only if you travelled 1 uni.",
		...
		61: "Rocket fuel resets nothing boolean(extreme+hikers_dream, and divide energy loss by time cube upgrades (minimum 1)).",
		...
		74: "The 'Time Doesnt Exist' reward is showNum(25)% stronger.",
		75: "Dark Fluid boosts Dark Flow",
		...
		83: "You can max all Repeatable Crematorium Upgrades and buying them does not consume ashes.",
